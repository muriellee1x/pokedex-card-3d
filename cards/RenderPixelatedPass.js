...
class RenderPixelatedPass extends Pass {
	...
	constructor( pixelSize, scene, camera, options = {} ) {
        ...
        this._beautyRenderTarget.stencilBuffer = true;
        ...
        this._normalRenderTarget.stencilBuffer = true;
	 ...
	 */
	render( renderer, writeBuffer, stencilRenderBuffer/*, readBuffer , deltaTime, maskActive */ ) {
        ...
        _gl.framebufferRenderbuffer(_gl.FRAMEBUFFER, _gl.DEPTH_STENCIL_ATTACHMENT, _gl.RENDERBUFFER, stencilRenderBuffer);    
